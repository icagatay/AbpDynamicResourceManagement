...
public class AbpDynamicResourceManagementDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AbpDynamicResourceManagementDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
